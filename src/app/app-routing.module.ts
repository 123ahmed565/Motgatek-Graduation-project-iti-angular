...
import { AddCategoriesComponent } from './components/admin-panel/add-categories/add-categories.component';
...
import { ProfileAddressesComponent } from './components/profile/profile-addresses/profile-addresses.component';
...
import { ProfileWishListsComponent } from './components/profile/profile-wish-lists/profile-wish-lists.component';
...
const routes: Routes = [
  ...
  { path: "register", component: RegisterComponent },
  {
    path: "profile", component: ProfileComponent, children: [
      ...
      { path: "address", component: ProfileAddressesComponent },
      { path: "wish-list", component: ProfileWishListsComponent },
  ...
  { path: "checkout", component: CheckoutComponent },
  {
    path: "admin", component: AdminPanelComponent, children: [
      ...
      { path: "new-category", component: AddCategoriesComponent },
